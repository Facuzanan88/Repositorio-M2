...
autor.innerHTML = "Aplicación creada por Facundo Zanandrea"; // autor.innerHTML = autor.innerHTML + 'Facundo';
...
function buildToDos(toDos) {
  // Tu código acá:
  let arr = toDos.map(function (todo, index) { // toDos.map(buildToDo);
